...
class UserSerializer
  ...
  attributes :profile, :completed_program, :expo_push_token, :app_update_required, :movement_program, :education_program, :access_to_wellness_coach, :wellness_coach_reminder, :wellness_coach_reminded, :last_date_on_app, :dates_on_app, :education_progress, :movement_progress, :movement_units

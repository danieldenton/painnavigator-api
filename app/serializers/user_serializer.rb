...
class UserSerializer
  ...
  attributes :profile, :onboard, :outcome, :expo_push_token, :education_program, :education_progress, :movement_progress, :conversation, :last_pain_journal_date, :last_mood_journal_date, :last_food_journal_date, :mood_journals, :pain_journals, :food_journals

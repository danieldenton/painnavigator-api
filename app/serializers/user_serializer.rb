...
class UserSerializer
  ...
  attributes :profile, :onboard, :outcome, :expo_push_token, :daily_pain_scores, :education_progress, :movement_progress, :conversation, :last_pain_journal_date, :last_mood_journal_date, :last_food_journal_date, :mood_journals, :pain_journals, :pain_graph_data, :food_journals, :smart_goals, :active_goal_updates

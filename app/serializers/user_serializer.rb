...
class UserSerializer
  ...
  attributes :profile, :outcome, :expo_push_token, :onboard_status, :condensed_program, :profile_status, :education_progress, :movement_progress, :conversation, :last_pain_journal_date, :last_mood_journal_date, :last_food_journal_date, :mood_journals, :pain_journals, :pain_graph_data, :food_journals, :smart_goals, :active_goal_updates, :completed_program

...
class UserSerializer
  ...
  attributes :profile, :onboard, :outcome, :expo_push_token, :education_program, :last_date_on_app, :dates_on_app, :education_progress, :movement_progress, :movement_units

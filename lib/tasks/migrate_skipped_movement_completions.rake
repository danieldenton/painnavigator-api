...
namespace :data do
  desc "Migrate skipped movement from User table to MovementModuleCompletions"
  task migrate_skipped_movement: :environment do
    
    User.all.each do |user|
      skipped_movement_units = user.skipped_movement_units
      ...
      skipped_movement_units.each do |video_id|
